...
When compiling and building images in the dayu system, please configure env parameter `REG` and `buildkitd.toml` to use the private repository. For details, please refer to [How to Build](/docs/v1.3/developer-guide/how-to-build).
