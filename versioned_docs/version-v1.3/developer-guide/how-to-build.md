...
Dayu relies on docker buildx to build multi-arch images for cloud/edge devices, you can refer to [Install Docker Buildx](/docs/v1.3/developer-guide/install-docker-buildx) to install docker buildx.
