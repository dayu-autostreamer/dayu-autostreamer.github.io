...
This step may occur [Question 4：10002 already in use](/docs/v1.3/getting-started/install-lower-layer-system/faqs#question-4-10002-already-in-use).
...
This step may occur [Question 5：edgecore file exists](/docs/v1.3/getting-started/install-lower-layer-system/faqs#question-5-edgecore-file-exists).
...
This step may occur [Question 25：keadm join error on edge nodes](/docs/v1.3/getting-started/install-lower-layer-system/faqs#question-25-keadm-join-error-on-edge-nodes).
