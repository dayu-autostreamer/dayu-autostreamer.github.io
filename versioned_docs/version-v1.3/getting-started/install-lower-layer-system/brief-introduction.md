...
For the specific functions and structure of the lower-layer system, please refer to [architecture](/docs/v1.3/architecture/brief-architecture).

## Installation Process

Please install in the following order:

- [Prepare for pre-requisites](/docs/v1.3/getting-started/install-lower-layer-system/pre-requisites)
- [Install Kubernetes](/docs/v1.3/getting-started/install-lower-layer-system/install-kubernetes)
- [Install KubeEdge](/docs/v1.3/getting-started/install-lower-layer-system/install-kubernetes)
- [Install EdgeMesh](/docs/v1.3/getting-started/install-lower-layer-system/install-kubeedge)
- [Install Sedna](/docs/v1.3/getting-started/install-lower-layer-system/install-edgemesh)
- [Install Nvidia GPU Support](/docs/v1.3/getting-started/install-lower-layer-system/install-nvidia-gpu-support)
