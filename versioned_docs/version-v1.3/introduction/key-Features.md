...
To understand how these features fit together, read the [architecture overview](/docs/v1.3/architecture/brief-architecture). To try the system, follow [getting started](/docs/v1.3/getting-started/preparation). To inspect the implementation, visit the [Dayu GitHub repository](https://github.com/dayu-autostreamer/dayu).
