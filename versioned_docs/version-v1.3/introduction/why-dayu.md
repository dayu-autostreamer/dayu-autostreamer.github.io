...
If you are new to Dayu, start with the [architecture overview](/docs/v1.3/architecture/brief-architecture), then follow the [getting started guide](/docs/v1.3/getting-started/preparation). The system implementation is available in the [Dayu GitHub repository](https://github.com/dayu-autostreamer/dayu).
