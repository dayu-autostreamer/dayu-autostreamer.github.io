...
This Step may occur [Question 6：TLSStreamPrivateKeyFile not exist](/docs/v1.4/getting-started/install-lower-layer-system/faqs#question-6-tlsstreamprivatekeyfile-not-exist)
...
NOTE: If using the [Intranet Image Repository](/docs/v1.4/developer-guide/configure-docker-registry), please modify the image in the yaml file, such as:
```
