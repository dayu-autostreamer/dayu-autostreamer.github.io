...
This step may occur [Question 1: kube-proxy report iptables problems](/docs/v1.4/getting-started/install-lower-layer-system/faqs#question-1-kube-proxy-report-iptables-problems), [Question 2: calico and coredns are always in initializing state](/docs/v1.4/getting-started/install-lower-layer-system/faqs#question-2-calico-and-coredns-are-always-in-initializing-state) and [Question 3：metrics-server keeps unsuccessful state](/docs/v1.4/getting-started/install-lower-layer-system/faqs#question-3-metrics-server-keeps-unsuccessful-state).
