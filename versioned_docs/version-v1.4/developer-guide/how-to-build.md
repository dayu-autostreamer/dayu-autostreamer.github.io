...
- Docker with the Buildx plugin and Bake support. See [Install Docker Buildx](/docs/v1.4/developer-guide/install-docker-buildx).
...
Use [Configure Docker Registry](/docs/v1.4/developer-guide/configure-docker-registry) when the output registry requires a
