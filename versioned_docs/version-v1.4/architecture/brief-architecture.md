...
- **[Basic System Layer](/docs/v1.4/architecture/basic-system-layer)** provides the cluster substrate across cloud and edge nodes.
- **[Intermediate Interface Layer](/docs/v1.4/architecture/intermediate-interface-layer)** provides runtime deployment and
  cross-node service communication.
- **[System Support Layer](/docs/v1.4/architecture/system-support-layer)** provides the user interface, system control,
  datasource management, and platform state.
- **[Collaboration Scheduling Layer](/docs/v1.4/architecture/collaboration-scheduling-layer)** coordinates task generation,
  scheduling, execution, result delivery, and resource observation.
- **[Application Service Layer](/docs/v1.4/architecture/application-service-layer)** provides user-composable AI services
