...
Start with the [architecture overview](/docs/v1.4/architecture/brief-architecture), then follow the
[getting started guide](/docs/v1.4/getting-started/preparation). Implementation-facing contracts live in the
