...
[Customize Scheduling](/docs/v1.4/developer-guide/how-to-develop/customize-scheduling) for the policy catalog and extension
points.
...
Read the [architecture overview](/docs/v1.4/architecture/brief-architecture), follow
[getting started](/docs/v1.4/getting-started/preparation), or use the
[developer guide](/docs/v1.4/developer-guide/how-to-develop) to extend Dayu.
