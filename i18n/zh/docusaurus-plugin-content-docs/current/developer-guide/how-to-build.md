...
- 支持 Buildx plugin 和 Bake 的 Docker。安装方法见[安装 Docker Buildx](/docs/developer-guide/install-docker-buildx)。
- 对目标镜像仓库具有 push 权限。
...
[配置 Docker 镜像仓库](/docs/developer-guide/configure-docker-registry)。
