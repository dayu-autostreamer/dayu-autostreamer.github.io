...
1. [自定义模板文件](/docs/getting-started/start-upper-layer-system/customize-template-files)。
2. [部署挂载文件](/docs/getting-started/start-upper-layer-system/deploy-mounted-files)。
3. [运行大禹系统](/docs/getting-started/start-upper-layer-system/run-dayu-system)。
