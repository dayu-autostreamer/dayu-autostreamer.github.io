...
该问题已在大禹`v1.3`版本被永久解决，使用最新的[大禹启动脚本](https://github.com/dayu-autostreamer/dayu/blob/main/dayu.sh)可以避免此问题。
...
## 问题三十二：edgemesh-agent 为 Running 但日志中 127.0.0.1:10550 connection refused
