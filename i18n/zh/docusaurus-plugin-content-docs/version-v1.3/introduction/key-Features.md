...
如需理解这些能力如何协同工作，请阅读[系统整体架构](/docs/v1.3/architecture/brief-architecture)。如需尝试运行系统，请从[系统准备](/docs/v1.3/getting-started/preparation)开始。系统实现可在 [Dayu GitHub 仓库](https://github.com/dayu-autostreamer/dayu)中查看。
