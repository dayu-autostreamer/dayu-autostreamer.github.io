...
如果你刚开始了解大禹系统，可以先阅读[系统整体架构](/docs/v1.3/architecture/brief-architecture)，再按照[系统准备](/docs/v1.3/getting-started/preparation)开始部署和运行。系统实现位于 [Dayu GitHub 仓库](https://github.com/dayu-autostreamer/dayu)。
