...
可能出现 [问题六：缺少 TLSStreamCertFile](/docs/v1.3/getting-started/install-lower-layer-system/faqs#问题六缺少-tlsstreamcertfile)
...
提示: 如果使用[内网镜像仓库](/docs/v1.3/developer-guide/configure-docker-registry)，请进入yaml文件中修改image源，如:
```
