...
请先完成[下层系统安装](/docs/v1.4/getting-started/install-lower-layer-system/brief-introduction)，再
[启动上层系统](/docs/v1.4/getting-started/start-upper-layer-system/brief-introduction)。
