...
可能出现 [问题四：10002 already in use](/docs/v1.4/getting-started/install-lower-layer-system/faqs#问题四10002-already-in-use)
...
可能出现 [问题五：edgecore-符号链接已存在](/docs/v1.4/getting-started/install-lower-layer-system/faqs#问题五edgecore-符号链接已存在)
...
可能出现 [问题二十五：边端join报错](/docs/v1.4/getting-started/install-lower-layer-system/faqs#问题二十五边端join报错)
...
如果您不再需要JetPack节点标签器或想要重新部署它，请删除DaemonSet及其相关资源：
