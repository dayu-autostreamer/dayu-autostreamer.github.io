...
- 添加 AI 服务：参见[添加应用](/docs/v1.4/developer-guide/how-to-develop/add-applications)。
- 添加调度策略或 hook：参见[自定义调度](/docs/v1.4/developer-guide/how-to-develop/customize-scheduling)。
- 添加其他运行时 hook：参见 [Hook Functions](/docs/v1.4/developer-guide/apis/hook-functions)。
