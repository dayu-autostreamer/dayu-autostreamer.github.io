...
Permanently, this error has been fixed after dayu v1.3 release. Use the latest [dayu script](https://github.com/dayu-autostreamer/dayu/blob/main/dayu.sh) can avoid this error.
...
## Question 32: Edgemesh-agent is Running but logs 127.0.0.1:10550 connection refused
