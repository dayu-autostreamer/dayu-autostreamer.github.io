...
- Add an AI service: follow [Add Applications](/docs/developer-guide/how-to-develop/add-applications).
- Add a scheduling policy or hook: follow
  [Customize Scheduling](/docs/developer-guide/how-to-develop/customize-scheduling).
- Add another runtime hook family: use [Hook Functions](/docs/developer-guide/apis/hook-functions).
