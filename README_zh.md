...
| --- | --- |
| `docs/` | 当前英文文档的源文件 |
| `i18n/zh/docusaurus-plugin-content-docs/current/` | 当前文档的简体中文翻译 |
...
[大禹系统代码仓库](https://github.com/dayu-autostreamer/dayu)中处理。
...
- 大禹系统代码仓库：<https://github.com/dayu-autostreamer/dayu>
- 大禹系统发布版本：<https://github.com/dayu-autostreamer/dayu/releases>
- 大禹系统问题反馈：<https://github.com/dayu-autostreamer/dayu/issues>
